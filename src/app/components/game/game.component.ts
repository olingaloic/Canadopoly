...
export class GameComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.properties.set(4, new Airport(4, "Trudeau Airport", 5000, [600, 1200, 2500, 5000]));
    ...
    this.properties.set(11, new Airport(11, "Pearson Airport", 5000, [600, 1200, 2500, 5000]));
    ...
    this.properties.set(18, new Airport(18, "Calgary Airport", 5000, [600, 1200, 2500, 5000]));
    ...
    this.properties.set(25, new Airport(25, "Vancouver Airport", 5000, [600, 1200, 2500, 5000]));
